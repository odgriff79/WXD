...
- If PERIODS shows divergent pattern, mention short-term vs mid/extended outlook, persistence if shown

SIGNAL AND TIMING:
- SIGNAL tells you event confidence: "locked" = certain, "strong" = very likely
- TIMING tells you the date window - use this, not a single day
